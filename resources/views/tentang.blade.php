    ...
    <div class="container text-center mt-3">
        <div class="row">
            <div class="col-sm-6 mb-3 mb-sm-0">
                <div class="card">
                <img src="https://i.im.ge/2025/01/25/HXislW.2.webp" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
            ...
            <div class="col-sm-6">
                <div class="card">
                <img src="https://i.im.ge/2025/01/25/HXia00.1.webp" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
